...
class OutsideRequest <T = RequestResponse,I = Record<string,any>,D = AxiosError<RequestConfigInstruction<T,I,AxiosError>>> implements OutsideRequestObject<T,I,D>{
    ...
    $all<T0=T,T1=T,T2=T,T3=T,T4=T,T5=T,T6=T,T7=T>(data:Array<PromiseExtend<T0 | T1 | T2 | T3 | T4 | T5 | T6 | T7>> | (()=> Array<PromiseExtend<T0 | T1 | T2 | T3 | T4 | T5 | T6 | T7>>),requestConfig:I & RequestConfigInstruction<T,I,D>){
