...
import { RequestConfigInstruction,DefaultRequestConfigInstruction,OutsideRequestObject,RequestResponse,ResponseData,RequestPlugin,InstructionPostOption,ResponseSuccess,InstructionOption,ExitTriggers,InstructionExit,ResponseTypeStatus,ResponseExtendChain,RequestExtend,RequestMessageOption } from './type';
export { RequestConfigInstruction,RequestResponse,ResponseData,RequestPlugin,InstructionPostOption,ResponseSuccess,InstructionOption,ExitTriggers,InstructionExit,ResponseTypeStatus,ResponseExtendChain,RequestExtend,RequestMessageOption,OutsideRequestObject }
...
export default {
    ...
    create<T=RequestResponse,I = Record<string, any>,D = AxiosError<RequestConfigInstruction<T,I,AxiosError>> >(config:RequestConfigInstruction<T,I,D>,axios?:AxiosStatic | any):OutsideRequestObject<T,I,D>{
        return new OutsideRequest<T,I,D>(config,axios || this.staticRequest);
    },

    // 可被平台强制绑定的 请求实例
    staticRequest:undefined as any,
