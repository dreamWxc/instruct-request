...
export default class SessionLocal extends Memory {
    ...
    setItem(key, value, option) {
        ...
        if (this.timeObject)
            platforms.platform.clearTimeout && platforms.platform.clearTimeout(this.timeObject[key]);
        if (!this.timeObject)
            this.timeObject = {};
    ...
    updateStorageOption() {
        ...
        this.setOptionTime = platforms.platform.setTimeout && platforms.platform.setTimeout(() => {
            if (this.updateExpire())
                return platforms.platform.clearTimeout && platforms.platform.clearTimeout(this.setOptionTime);
